from dataloaders.datasets import dfc19seg
...
def make_data_loader(args, **kwargs):
    ...
    if args.dataset == 'dfc19seg':
        ...
        train_set = dfc19seg.DFCSegmentation(args, split='train',file=trn_file)
        val_set = dfc19seg.DFCSegmentation(args, split='val',file=val_file)
...
def make_test_loader(args, **kwargs):
    ...
    if args.dataset == 'dfc19seg':        
        test_set = dfc19seg.DFCSegmentation(args, split='test')
