...
def main():
    ...
    # checking point
    parser.add_argument('--resume', type=str, default='/data/yonghao.xu/DFC2019/track1/deeplabv3_DSM/run/dfc19dsm/deeplab-resnet/LogMSE_1024_OS16_CorrectDSM14_48/checkpoint.pth.tar',
