class Path(object):
    ...
    def db_root_dir(dataset):
        if dataset == 'pascal':
            ...
            return '/data/Public Data/IEEE Data Fusion Contest 2019/DFC2019_track1_trainval/Train-Track1/'
            ...
            return '/data/Public Data/IEEE Data Fusion Contest 2019/DFC2019_track1_trainval/Split-Val/'#Test-Track1
